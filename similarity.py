...
if __name__ == '__main__':
    ...
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '1986年农村人口超过城镇人口的有哪些省?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '1986年人口不大于1亿的省有哪些?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '1985年人口大于全国平均值的有哪些省?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '云南省的人口有多少?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '现存的人口问题有哪些?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '高考科目有哪些?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '1986年人口在1亿到两亿之间的有哪些省?')
    print(f'similarity：{predict[0][1]}')
    predict = sim.predict('2008年人口小于1亿的省有哪些?', '1986年人口超过一亿并且男女比例低于0.4的有哪些省?')
    print(f'similarity：{predict[0][1]}')
